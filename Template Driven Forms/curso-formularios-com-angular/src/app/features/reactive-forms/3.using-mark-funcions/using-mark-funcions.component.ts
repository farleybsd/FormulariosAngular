...
@Component({
  selector: 'app-using-mark-funcions',
  imports: [ReactiveFormsModule],
  templateUrl: './using-mark-funcions.component.html',
  styleUrl: './using-mark-funcions.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UsingMarkFuncionsComponent {
